...
const T = {
  en: {
    ...
    premPaid:  ['Everything in Free', 'Purchase beautiful themes', 'Advanced reports & charts', 'Export your data (CSV)', 'Priority support'],
    freeLabel:   'Free',
    premLabel:   'Premium',
  ...
  ar: {
    ...
    premPaid:  ['كل ما في النسخة المجانية', 'شراء الثيمات المميزة', 'تقارير وإحصائيات متقدمة', 'تصدير البيانات (CSV)', 'دعم أولوية'],
    freeLabel:   'مجاني',
    premLabel:   'بريميوم',
