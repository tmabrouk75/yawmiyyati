...
const T = {
  en: {
    ...
    feat: [
      ...
      { icon: '📊', title: 'Reports & Stats',    sub: 'Weekly summaries, heatmaps, and streaks to see your progress over time.', color: '#0ea5e9' },
    ],
    ...
    premiumTitle: 'Free forever. Go deeper when ready.',
    ...
    premPaid:  ['Everything in Free', 'To-Do lists & task management', 'Personal diary entries', 'Groups & collaboration', 'Purchase beautiful themes', 'Advanced reports & charts', 'Export your data (CSV)', 'Priority support'],
    freeLabel:   'Free',
    premLabel:   'Premium',
  ...
  ar: {
    ...
    feat: [
      ...
      { icon: '📊', title: 'التقارير والإحصائيات', sub: 'ملخصات أسبوعية وخرائط حرارية وسلاسل لمتابعة تقدمك عبر الزمن.', color: '#0ea5e9' },
    ],
    ...
    premiumTitle: 'مجاني للأبد. تعمّق أكثر عندما تكون مستعداً.',
    ...
    premPaid:  ['كل ما في النسخة المجانية', 'قوائم المهام وإدارة الأعمال', 'مدخلات يومياتك الشخصية', 'المجموعات والتعاون', 'شراء الثيمات المميزة', 'تقارير وإحصائيات متقدمة', 'تصدير البيانات (CSV)', 'دعم أولوية'],
    freeLabel:   'مجاني',
    premLabel:   'بريميوم',
